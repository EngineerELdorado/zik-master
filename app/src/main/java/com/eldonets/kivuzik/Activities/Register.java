...
import com.eldonets.kivuzik.Utilities.ExifUtil;
import com.eldonets.kivuzik.Utilities.Station_Util;
import com.eldonets.kivuzik.Utilities.Utility;
...
*/
                ...
                if (hasSpecialChar) {
                    Snackbar snackbar = Snackbar.make(scrollview, "le username doit containir des lettres et des chiffres seulement", Snackbar.LENGTH_LONG);
                    snackbar.show();
                } else {
                    ...
                    if (!isValidEmail(email)) {
                        edttxt_emailid.setError("Email invalid");
                    } else if (!isValidPassword(pass)) {
                        edttxt_password.setError("mot de passe trop court");
                    } else if (Edittxt_password.equals(Edittxt_confirm_password)) {
                        postdata();
                    } else {
                        Snackbar snackbar = Snackbar.make(scrollview, "les deux mots de passe ne sont pas identiques", Snackbar.LENGTH_LONG);
                        snackbar.show();
                    }
                }
            }
    ...
    private void takepicture() {
        final CharSequence[] items = {"Prendre une photo", "Gallery", "Annuler"};
        AlertDialog.Builder builder = new AlertDialog.Builder(Register.this, R.style.YourDialogStyle)
                .setIcon(R.drawable.ic_add_photo).setTitle("Ajouter Photo!");
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                if (items[item].equals("Prendre une photo")) {
                    ...
                    startActivityForResult(Intent.createChooser(intent, "Selectionner Fichier"), PICK_IMAGE_REQUEST);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == CLICKED_IMAGE && resultCode == RESULT_OK) {
            ...
            Toast.makeText(this, "tu nás pas selectioné de photo",
    ...
    private void postdata() {
        ...
        client.post("http://www.kivuzik.com/myapi/registration.php", requestParams, new JsonHttpResponseHandler() {
            @Override
            public void onStart() {
                ...
                try {
                    if (response.getString(KEY_SUCCESS) != null) {
                        ...
                        if (Integer.parseInt(res) == 1) {
                            Toast.makeText(Register.this, "Votre Compte a ete cree avec success.!:)", Toast.LENGTH_LONG).show();
                            pDialog.dismiss();
                            Intent i = new Intent(Register.this, Login.class);
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                ...
                pDialog.dismiss();
                Toast.makeText(Register.this, errorResponse.toString(), Toast.LENGTH_LONG).show();
            }
