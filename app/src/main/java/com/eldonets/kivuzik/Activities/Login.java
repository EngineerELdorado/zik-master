...
import com.eldonets.kivuzik.Notifications.RegistrationIntentService;
...
public class Login extends AppCompatActivity implements View.OnClickListener {
            ...
            GraphRequest request = GraphRequest.newMeRequest(loginResult.getAccessToken(), new GraphRequest.GraphJSONObjectCallback() {
                ...
                public void onCompleted(JSONObject object, GraphResponse response) {
                    ...
                    if (str_location != null) {
                        ...
                        str_city = split[0];
                        str_country = split[1];
                   /* System.out.println("----facebook profile city---"+str_city);
                    System.out.println("----facebook profile country---"+str_country);*/
            ...
            throws UnrecoverableKeyException, NoSuchAlgorithmException, KeyStoreException, KeyManagementException, IOException, CertificateException
    {
        ...
        //Log.d("PROFILE_PIC", String.valueOf(profile_pic));
        ...
        client.post(this,Station_Util.URL + "fblogin.php", requestParams, new JsonHttpResponseHandler() {
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                ...
                pDialog.dismiss();
                Toast.makeText(Login.this, errorResponse.toString(), Toast.LENGTH_LONG).show();
            }
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONArray errorResponse) {
                super.onFailure(statusCode, headers, throwable, errorResponse);
                pDialog.dismiss();
                Toast.makeText(Login.this, errorResponse.toString() + "-1", Toast.LENGTH_LONG).show();
            }
            ...
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                ...
                pDialog.dismiss();
                Toast.makeText(Login.this, responseString.toString() + "-2", Toast.LENGTH_LONG).show();
            }
        });
...
//
    ...
    public void onClick(View v) {
        ...
        }else if (v==btn_skip_guest)
        {
            ...
            if (!edttxt_username_login.getText().toString().equals("") && !edttxt_password_login.getText().toString().equals("")) {
                ...
                Toast.makeText(getApplicationContext(), "Veillez entrer votre email et mot de passe", Toast.LENGTH_SHORT).show();
            }
    ...
    private void GetData() {
        ...
        client.get(Station_Util.URL+"loginapi.php?useremail=" + useremail + "&password=" + password, new JsonHttpResponseHandler() {
            @Override
            public void onStart() {
                pDialog.setTitle("en communication avec le serveur");
                ...
                try {
                    if (response.getString(KEY_SUCCESS) != null) {
                        ...
                        if (Integer.parseInt(res) == 1) {
                            ...
                            Toast.makeText(Login.this, "Bienvenu! :)"+username, Toast.LENGTH_LONG).show();
                            pDialog.dismiss();
