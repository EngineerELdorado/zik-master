...
public class Guest_activity extends AppCompatActivity implements View.OnClickListener, View.OnLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (str_userimage.equalsIgnoreCase("") | str_userimage.isEmpty() | str_cover_image.isEmpty() | str_cover_image.equalsIgnoreCase("")) {
            ...
            Picasso.with(Guest_activity.this)
                    .load(Station_Util.IMAGE_URL_AVATARS + str_userimage)
                    .placeholder(R.drawable.camera_icontwo)
                    .into(circleImageView);

            if (android.os.Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN) {
                Picasso.with(Guest_activity.this).load(Station_Util.IMAGE_URL_COVERS + str_cover_image).transform(new Blur(Guest_activity.this, 25))
                        .placeholder(R.drawable.camera_icontwo)
                        .into(Iv_cover);
                Log.e("CHECK VERSION", "GREATER");
            } else {
                Picasso.with(Guest_activity.this).load(Station_Util.IMAGE_URL_COVERS + str_cover_image)
                        .placeholder(R.drawable.camera_icontwo)
                        .into(Iv_cover);
