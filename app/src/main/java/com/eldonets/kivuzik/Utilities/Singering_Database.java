...
public class Singering_Database extends SQLiteOpenHelper {
    ...
    public void insertPlaylist(String playlist_id,String playlist_name,String playlist_image)
    {
        db=this.getWritableDatabase();
        ContentValues cv234=new ContentValues();
        cv234.put(PLAYLIST_ID1,playlist_id);
        cv234.put(PLAYLIST_NAME,playlist_name);
        cv234.put(PLAYLIST_IMAGE,playlist_image);

        db.insert(TABLE_NAME_COUNT,null,cv234);
        System.out.println("----data inserted----");
        db.close();
    }


/*    public List get_Playlist(String playlist_id, String playlist_name, String playlist_image)
    {
        String check="";
