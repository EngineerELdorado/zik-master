package com.eldonets.kivuzik.Utilities;
...
public class Station_Util {
    ...
    public static String URL = "http://kivuzik.com/myapi/";
    public static String IMAGE_URL_MEDIA = "http://kivuzik.com/uploads/media/";
    public static String IMAGE_URL_COVERS = "http://kivuzik.com/uploads/covers/";
    public static String IMAGE_URL_AVATARS = "http://kivuzik.com/uploads/avatars/";
    public static String TRACK_PATH = "http://kivuzik.com/uploads/tracks/";

    public static boolean state_ended = false;
    public static int checkended;
