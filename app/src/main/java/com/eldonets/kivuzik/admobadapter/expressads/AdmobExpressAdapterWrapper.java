...
public class AdmobExpressAdapterWrapper extends BaseAdapter implements AdmobFetcherBase.AdmobListener {
    ...
    private final String TAG = com.eldonets.kivuzik.admobadapter.expressads.AdmobExpressAdapterWrapper.class.getCanonicalName();
...
*/
    ...
    */
     ...
     * @see com.eldonets.kivuzik.admobadapter.expressads.AdmobExpressAdapterWrapper#setNoOfDataBetweenAds(int)
     * @see com.eldonets.kivuzik.admobadapter.expressads.AdmobExpressAdapterWrapper#getNoOfDataBetweenAds()
     */
    @Override
    public int getCount() {
