...
import com.eldonets.kivuzik.admobadapter.AdPresetCyclingList;
...
public class AdmobFetcherExpress extends AdmobFetcherBase {
    ...
    private final String TAG = com.eldonets.kivuzik.admobadapter.expressads.AdmobFetcherExpress.class.getCanonicalName();
